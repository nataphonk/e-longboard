...
#define RS                     0.28 /* Stator resistance , ohm*/
#define LS                     0.000099 /* Stator inductance, H
...
#define NOMINAL_CURRENT         2722
#define MOTOR_MAX_SPEED_RPM     2000 /*!< Maximum rated speed  */
#define MOTOR_VOLTAGE_CONSTANT  23.9 /*!< Volts RMS ph-ph /kRPM */
#define ID_DEMAG                -2722 /*!< Demagnetization current */
